...
const before1500 = inventors.filter((dob) => {
  return dob.year > 1500 && dob.year < 1600;
});
...
const names = inventors.map((info) => {
...
const years = inventors.reduce((accumulator, currentValue) => {
